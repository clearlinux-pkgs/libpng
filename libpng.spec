...
%prep
%setup -q -n libpng-1.6.38
cd %{_builddir}/libpng-1.6.38
pushd ..
cp -a libpng-1.6.38 build32
popd
pushd ..
cp -a libpng-1.6.38 buildavx2
popd
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpng16.so.16.38.0
