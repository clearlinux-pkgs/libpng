...
Source0  : https://sourceforge.net/projects/libpng/files/libpng16/1.6.45/libpng-1.6.45.tar.gz
...
%prep
%setup -q -n libpng-1.6.45
cd %{_builddir}/libpng-1.6.45
pushd ..
cp -a libpng-1.6.45 build32
popd
pushd ..
cp -a libpng-1.6.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736377694
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpng16.so.16.45.0
/usr/lib64/libpng16.so.16
/usr/lib64/libpng16.so.16.45.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpng16.so.16
/usr/lib32/libpng16.so.16.45.0
