...
Source0  : https://sourceforge.net/projects/libpng/files/libpng16/1.6.43/libpng-1.6.43.tar.gz
...
%prep
%setup -q -n libpng-1.6.43
cd %{_builddir}/libpng-1.6.43
pushd ..
cp -a libpng-1.6.43 build32
popd
pushd ..
cp -a libpng-1.6.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719967242
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpng16.so.16.43.0
/usr/lib64/libpng16.so.16
/usr/lib64/libpng16.so.16.43.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpng16.so.16
/usr/lib32/libpng16.so.16.43.0
