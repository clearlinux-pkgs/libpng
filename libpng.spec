...
Source0  : https://sourceforge.net/projects/libpng/files/libpng16/1.6.42/libpng-1.6.42.tar.xz
...
%prep
%setup -q -n libpng-1.6.42
cd %{_builddir}/libpng-1.6.42
pushd ..
cp -a libpng-1.6.42 build32
popd
pushd ..
cp -a libpng-1.6.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706731003
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpng16.so.16.41.0
/usr/lib64/libpng16.so.16
/usr/lib64/libpng16.so.16.41.0
